...
<br>           저희 같은 경우는 파트 별로 나눠져 있으니깐 깃에 push할 때 자기 파트만..
<br>           예를 들자면 저는 제가 맡은 파트인 다시보기(replay) 관련 소스들(ReplayController, replay/list.jsp .... etc)만 push 하면 pull을 깜빡했더라도 괜찮을 꺼 같습니다
